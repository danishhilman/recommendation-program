"""This python file is used to parse data from a csv file, and return a sorted python dictionary"""
...
#TURN this code to an actual dictionary to replace the raw pokedex
